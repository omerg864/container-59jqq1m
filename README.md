...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-59jqq1m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-59jqq1m.containers.anotherwebservice.com/
...
```
git clone git@github.com:omerg864/container-59jqq1m.git
cd container-59jqq1m
```
...
```
docker attach container-59jqq1m
```
